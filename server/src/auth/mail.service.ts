                ...
                html: `
                    ...
                    <head>
                        ...
                        <style>
                            ...
                            .btn { display: inline-block; padding: 16px 40px; background: linear-gradient(135deg, #3b82f6, #2563eb); color: #fff !important; text-decoration: none; border-radius: 12px; font-weight: 700; font-size: 15px; }
                ...
                html: `
                    ...
                    <head>
                        ...
                        <style>
                            ...
                            .body p span { color: #e2e8f0; font-weight: 600; }
                            .btn-wrap { text-align: center; margin: 32px 0; }
                            .btn { display: inline-block; padding: 16px 40px; background: linear-gradient(135deg, #6366f1, #4f46e5); color: #fff !important; text-decoration: none; border-radius: 12px; font-weight: 700; font-size: 15px; }
                            .note { color: #64748b !important; font-size: 13px !important; margin-top: 24px !important; }
                            .footer { padding: 20px 40px; border-top: 1px solid rgba(255,255,255,0.05); text-align: center; }
                            .footer p { color: #475569; font-size: 12px; margin: 0; }
                        </style>
                    ...
                    <body>
                        <div class="wrapper">
                            ...
                            <div class="body">
                                <p>Вітаємо!</p>
                                <p>Вас було запрошено до освітньої платформи <span>C++ Платформа</span> як викладача. Для завершення реєстрації натисніть кнопку нижче:</p>
                                <div class="btn-wrap">
                                    <a href="${setupUrl}" class="btn">Активувати акаунт</a>
                                </div>
                                <p class="note">Посилання дійсне протягом <strong>24 годин</strong>. Якщо ви не очікували цього запрошення — проігноруйте цей лист.</p>
                            </div>
                            <div class="footer">
                                <p>© 2026 C++ Платформа · КНУ</p>
                            </div>
